...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
  return (
    <thead
      ...
      className={cn(
        '[&_tr]:border-b-2 [&_tr]:border-border bg-main',
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot='table-row'
      className={cn(
        'border-b-2 border-border transition-colors text-main-foreground font-base data-[state=selected]:bg-secondary-background data-[state=selected]:text-main-foreground',
        className,
      )}
      {...props}
    />
